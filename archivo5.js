/* rm -rf .git sirve para sacar el master 

git help aparece un listado de comando


Mkdir crea una carpeta vacia
Cd                   para ingresar a una carpeta 
cd ..                para volver a tras 
clear                limpia la pantalla
touch                  crea un archivo vacio (aclarar la extensión del archivo ej .py)
rm -r                       elimina el archivo seleccionado 
help                        nos muestra un listado de comandos básicos



git commit --amend -m --> comando util para renombrar el commit por si nos equivocamos en la descripcion 
